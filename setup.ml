...
(* OASIS_START *)
(* DO NOT EDIT (digest: ef9dfdbf5fec3acccca2fc07da644d20) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Zipper"];
                      lib_pack = false;
                      lib_internal_modules = ["Branch"];
                      lib_findlib_parent = Some "iron";
                      lib_findlib_name = Some "zipper";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   })
            ];
     ...
     oasis_digest = Some "\186\207\001Z\208\142~OOE\192\196\2058\007\220";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
